...
mutation CreateGooglemodfi($change1: String!,$change2: String, $change3: String){
...
mutation CreateFacebookmodfi($change1: String!,$change2: String, $change3: String){
  createFacebookmodif(change1:$change1, change2: $change2, change3: $change3){
    change1
    change2
    change3
  }
...
mutation CreateWebmodfi($change1: String!,$change2: String, $change3: String){

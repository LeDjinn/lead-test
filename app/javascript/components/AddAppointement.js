...
export const AddAppointement =()=> {
    ...
    return <form onSubmit={onSubmit}>
        <div>
            ...
            <input className="border-2 rounded-xl mt-2 mb-2 text-xl" type ='text' name ="motif" placeholder= "Votre motif de rendez vous"/>
            <input type ='datetime-local' name ="date"/>
        </div>
        <button className='text-2xl text-indigo-200 font-bold'>Prendre rendez-vous</button>
    </form>
}